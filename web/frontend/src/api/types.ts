...
export interface ChartResponse { schema_version: 1; request: AnalysisRequest; meta: { instrument: string; period: string; source: string; first_bar: string; last_bar: string; bar_count: number }; candles: Candle[]; indicators: { macd: MacdPoint[] }; overlays: { bi: LineOverlay[]; segments: LineOverlay[]; zones: ZoneOverlay[]; buy_sell_points: BuySellPoint[] } }
