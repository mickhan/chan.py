...
BaoStock 和 AkShare 对全部标的没有可靠的通用历史边界，因此能力接口中的日期边界可能为空。分析时如果请求起点与实际首根 K 线之间相差明显超过日线 10 天、周线 18 天或月线 45 天，会返回 `DATE_RANGE_UNAVAILABLE`，避免把上市前历史静默截成局部数据；短暂休市仍允许首根 K 线晚于请求起点。
