"""Render the saved Sina 30-minute data: python examples/run_chinext_30m.py."""
import json
import os
import sys
...
rows = json.loads((ROOT / 'output/chinext_30m_source.json').read_text())
...
chan = CChan(code='sz.399006', data_src=DATA_SRC.CSV,
...
plot.save2img(str(ROOT / 'output/chinext_30m.png'))
...
(ROOT / 'output/chinext_30m_summary.json').write_text(json.dumps(summary,indent=2)+'\n')
