"""Render the saved Sina 30-minute data: python examples/run_shanghai_30m.py."""
import json
import os
import sys
...
rows = json.loads((ROOT / 'output/shanghai_30m_source.json').read_text())
...
chan = CChan(code='sh.000001', data_src=DATA_SRC.CSV,
...
plot.save2img(str(ROOT / 'output/shanghai_30m.png'))
...
(ROOT / 'output/shanghai_30m_summary.json').write_text(json.dumps(summary,indent=2)+'\n')
